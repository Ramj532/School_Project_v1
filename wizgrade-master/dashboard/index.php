...
?>	
		...
		<body class="lock-screen" onLoad="startTime()"> 
			...
			<div id="scrollBTarget" class="loader-background timeOutLoader">
				<img src="<?php echo $wizGradeTemplate?>images/loading.gif" alt="please wait. Page loading >>>>>>>>>>>>>>>  dashboard/index.php 1111" /><!-- loading image -->						 
			</div>
		...
		<section id="main-content">
			...
			<section class="wrapper site-min-height" id="scrollTargetMPage" > 
				...
				<div class="loader-background">
					...
					alt="please wait. Page loading >>>>>>>>>>>>>>> dashboard/index.php" /><!-- loading image -->					 
				</div>
